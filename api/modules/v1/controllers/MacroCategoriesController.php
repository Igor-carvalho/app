...
class MacroCategoriesController extends ActiveController
{
    public $modelClass = 'app\models\database\ActivitiesMacroCategories';
    ...
    public function actionIndex()
    {
        return new ActiveDataProvider([
            'query' => SystemMacroCategories::find()
                ->select(['id', 'label'])
                ->where([
                ])
        ]);
    ...
    {
        $record = SystemMacroCategories::find()->where([
            'id' => $id,
        ])->one();
        if ($record) {
            return $record;
    ...
    {
        $model = new SystemMacroCategories();
